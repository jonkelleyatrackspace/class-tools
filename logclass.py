import logging
""" This can be included by other files as a module so you can implement logging centrally. 
    When you create the logclass instance, the first arguement descriebs the file you're calling it from.
    That way you can track the source of a log message being generated."""
# ------------------------------------------------------------------------
...
class LogClass():
    def __init__(self,moduleinstancename):
        # Logger.
